        ...
        <form method="POST" action="" @submit.prevent="onSubmit" enctype="multipart/form-data">
            ...
            <div class="page-content">
                ...
                @foreach ($product->attribute_family->attribute_groups as $index => $attributeGroup)
                    <?php 
                        /*if ($attributeGroup->name == 'Meta Description' ) {
                            continue;
                        } */
                    ...
                    @if (count($customAttributes))
                        ...
                        <accordian :title="'{{ __($attributeGroup->name) }}'"
                            ...
                            <div slot="body">
                               ...
                               <!-- {{$attribute->code}}-->
                                    <?php
                                        if ($attribute->code == 'product_number' || $attribute->code == 'tax_category_id' || $attribute->code == 'brand') {
                                            continue;
                                        }
                ...
                @foreach ($product->getTypeInstance()->getAdditionalViews() as $view)
                    @if ($view != 'admin::catalog.products.accordians.channels') 
                    @include ($view)
                    @endif
