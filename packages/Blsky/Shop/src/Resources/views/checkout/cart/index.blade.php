                ...
                <div class="left-side">
                    <form action="{{ route('shop.checkout.cart.update') }}" method="POST" @submit.prevent="onSubmit">
                                ...
                                <div class="item mt-5">
                                    ...
                                    <div class="item-details">
                                        ...
                                        <div class="misc">
                                            ...
                                            <span class="">
                                                <a class="btn btn-dark" href="{{ route('shop.checkout.cart.remove', $item->id) }}" onclick="removeLink('{{ __('shop::app.checkout.cart.cart-remove-action') }}')"><!--{{ __('shop::app.checkout.cart.remove-link') }}--><i class="fa fa-trash-o text-white" aria-hidden="true"></i>
</a></span>
                        ...
                        <div class="misc-controls">
                            <div><a href="{{ route('shop.home.index') }}" class="btn btn-lg btn-primary">{{ __('shop::app.checkout.cart.continue-shopping') }}</a></div>
