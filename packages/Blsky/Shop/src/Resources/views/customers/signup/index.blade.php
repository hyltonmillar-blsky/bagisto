...
<div class="auth-content">
    ...
    <div class="sign-up-text">
        {{ __('shop::app.customer.signup-text.account_exists') }} - <a class="text-secondary" href="{{ route('customer.session.index') }}">{{ __('shop::app.customer.signup-text.title') }}</a>
    </div>
    ...
    <form method="post" action="{{ route('customer.register.create') }}" @submit.prevent="onSubmit">
        ...
        <div class="login-form">
            ...
            {{-- <div class="control-group" :class="[errors.has('agreement') ? 'has-error' : '']">
                ...
                <span>{{ __('shop::app.customer.signup-form.agree') }}
                    <a class="text-secondary" href="">{{ __('shop::app.customer.signup-form.terms') }}</a> & <a href="">{{ __('shop::app.customer.signup-form.conditions') }}</a> {{ __('shop::app.customer.signup-form.using') }}.
                </span>
                <span class="control-error" v-if="errors.has('agreement')">@{{ errors.first('agreement') }}</span>
            </div> --}}
